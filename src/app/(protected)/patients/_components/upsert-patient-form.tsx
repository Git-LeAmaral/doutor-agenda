  ...
  return (
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>
          {patient ? "Edite as informações do paciente" : "Adicione um novo paciente."}
        </DialogDescription>
      </DialogHeader>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <DialogFooter>
            <Button type="submit" disabled={upsertPatientAction.isPending} className="w-full">
              {upsertPatientAction.isPending ? (patient ? "Atualizando..." : "Adicionando...") : patient ? "Atualizar" : "Adicionar"}
            </Button>
          </DialogFooter>
        </form>
      </Form>
